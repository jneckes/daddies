...
const MEMBERS = {
  'josh-guitar': {
    ...
    bio: 'Josh built The Daddies the way all great Los Angeles institutions get built: in a garage, over a group chat, against several people’s better judgment. He plays lead, books the gigs, and believes — sincerely, annoyingly — in the encore.',
  },
  'josh-drums': {
    stamp: 'DADDY DOSSIER — No. 02',
    name: 'JOSH',
    role: 'DRUMS · THE OTHER JOSH',
    ph: 'J',
    img: 'assets/img/daddies/josh-drums.jpg',
    stats: {
      'Weapon': 'A kit older than the internet',
      'Signature move': 'The fill you didn’t ask for',
      'Tempo': 'His opinion, and he’s entitled to it',
      'Counts to': 'Four, professionally',
      'Yes': 'Another Josh. We know.',
    },
    bio: 'Every band needs a heartbeat. Ours is a man named Josh hitting things in rhythm with alarming commitment. Legally distinct from the other Josh. Spiritually identical.',
  },
  'alex': {
    ...
    stats: {
      ...
      'Pockets': 'Feels them. Owns many. (Cargo.)',
      'Volume': 'Felt, not heard. Then felt again.',
    },
    bio: 'Alex is the reason your chest hurts in a good way during the chorus. The foundation of the house. The slab. Ask him about tone and he will simply nod.',
  },
  'seth': {
    stamp: 'DADDY DOSSIER — No. 04',
    name: 'SETH',
    role: 'GUITAR · MORE GUITAR',
    ph: 'S',
    img: 'assets/img/daddies/seth-guitar.jpg',
    stats: {
      'Weapon': 'A pedalboard with its own zip code',
      'Signature move': 'The harmony lean',
      'Relationship to Josh': 'Guitar détente. It’s working.',
      'Solo policy': 'When provoked',
    },
    bio: 'Yes, two guitars. We held a summit. Seth brings the shimmer, the crunch, and the harmony part that makes the wives look up from their phones. Diplomacy through riffage.',
  },
  'amy': {
    ...
    bio: 'Amy is what happens when real talent wanders into a dad band and decides to stay out of kindness. She hits the notes the daddies point at — all of them, including the Whitney ones.',
  },
  'erin': {
    ...
    stats: {
      'Weapon': 'Harmonies and eye contact',
      'Signature move': 'Getting your whole table to sing',
      'Energy': 'The good kind of too much',
      'Aux privileges': 'Permanent',
    },
    bio: 'Erin makes the whole room believe they’re in the band. Harmonies, hype, and the uncanny ability to find the one person not dancing and fix that within a verse.',
  },
  'brian': {
